  ...
  <body onload="javascript:resizemf();">
    ...
    <div class="header-back">
      ...
      <div id="header-front" >
        ...
        <div class="menu-button" >
          <a href="carrito.php" ><span style="visibility:hidden;display:none;" >VER CARRITO</span><div id="menu-button-carrito" style="background-image:url(resources/buttonbox/carrito-color.png);" ></div></a> 
        </div>
        <div class="menu-button" >
    ...
    <div id="workarea" >
      ...
      <div id="carrito" ><? showOrdered(); ?></div>
    </div>
