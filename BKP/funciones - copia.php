...
function showOrdered()
{
  if(count($_SESSION['pedido']))
  {
    ...
    if(isset($_GET['carrito']) && $_GET['carrito']=='fill')
    {
      ...
      $buffer.='<td><label class="form-text" >Razón Social</label><br/><input style="width:227px;" type="text" name="socialreason" /></td></tr></table></td></tr>';
      ...
      $buffer.='<td><label class="form-text" >Teléfono</label><br/><input style="width:101px;" type="text" name="tel" /></td>';
      ...
      $buffer.='<td><label class="form-text" >Categoría I.V.A.</label><input style="width:94px;" type="text" name="cativa" /></td></tr></table></td></tr>';
      ...
      $buffer.='<tr><td><label class="form-text" >Contraseña</label></td><td><input type="password" name="password"/></td></tr>';
      $buffer.='<tr><td><label class="form-text" >Confirmar Contraseña</label></td><td><input type="password" name="cpassword"/></td></tr>';
      $buffer.='</table><br/>';
...
//      prddint '<pre>_POST '; print_r($_POST); print '</pre>';
      if($_POST['savedata']=='on')
      {
        ...
        if(!empty($error))
        {
          ...
          $buffer.='<td><label class="form-text" >Razón Social</label><br/><input style="width:227px;" type="text" name="socialreason" value="'.$_POST['socialreason'].'" /></td></tr></table></td></tr>';
          ...
          $buffer.='<td><label class="form-text" >Teléfono</label><br/><input style="width:101px;" type="text" name="tel" value="'.$_POST['tel'].'" /></td>';
          ...
          $buffer.='<td><label class="form-text" >Categoría I.V.A.</label><input style="width:94px;" type="text" name="cativa" value="'.$_POST['cativa'].'" /></td></tr></table></td></tr>';
    ...
    else if(isset($_GET['carrito']) && $_GET['carrito']=='login')
    {
      ...
      $buffer.='</form>';
      $buffer.='<br/><br/><a href="productos.php?carrito=recover" >Recuperar contraseña</a>';
      echo $buffer;  
    }
    else if(isset($_GET['carrito']) && $_GET['carrito']=='dologin')
    {
      ...
      if($query->NumRows()!=0 && $query->NextValue())
      {
        ...
        $buffer.='<td><label class="form-text" >Razón Social</label><br/><input style="width:227px;" type="text" name="socialreason" value="'.$query->result['FIRMNAME'].'" /></td></tr></table></td></tr>';
        ...
        $buffer.='<td><label class="form-text" >Teléfono</label><br/><input style="width:101px;" type="text" name="tel" value="'.$query->result['TELEPHONE'].'" /></td>';
        ...
        $buffer.='<td><label class="form-text" >Categoría I.V.A.</label><input style="width:94px;" type="text" name="cativa" value="'.$query->result['CATIVA'].'" /></td></tr></table></td></tr>';
      ...
      else
      {
        ...
        $buffer.='<label class="form-text">Usuario o contraseï¿½a invalida</label>';
        $buffer.='<form action="carrito.php?carrito=dologin" method="post" >';
        $buffer.='<table>';
        $buffer.='<tr><td><label class="form-text" >Nombre de Usuario</label></td><td><input type="text" name="username"/></td></tr>';
        $buffer.='<tr><td><label class="form-text" >Contraseña</label></td><td><input type="password" name="password"/></td></tr>';
        ...
        $buffer.='<input style="position:relative;top:10px;left:120px;" type="image" src="resources/boton_enviar_contacto.png" value="submit">';
        $buffer.='</form>';
        $buffer.='<a href="carrito.php?carrito=recover" >Recuperar contraseï¿½a</a>';
        echo $buffer;  
      }
    }
    ...
    else if(isset($_GET['carrito']) && $_GET['carrito']=='dorecover')
    {
      ...
      if($query->NumRows()!=0 && $query->NextValue())
      {
        ...
        $subject = 'Recuperación de contraseña - peluchesfantasia.com';
        $headers = 'From: PELUCHESFANTASIA.COM <info@peluchesfantasia.com>' . "\r\n" .
                   'Reply-To: pedido@peluchesfantasia.com' . "\r\n" .
                   'X-Mailer: PHP/' . "\r\n" .
                   'Content-type: text/html' . "\r\n";
        $message = 'Su contraseña es: '.$query->result['PASSWORD'];
        $buffer='<img src="resources/barra_pedido_login.jpg" />';
        if(mail($to, $subject, $message, $headers))
        {
          $buffer.='<label class="form-text">La contraseña fue enviada a su email</label>';
  ...
  {
    echo '<p class="contact-message-success" >No hay ningún producto agregado al pedido</p>';
  }
}
...
'Content-type: text/html' . "\r\n";
  ...
  if(mail($to, $subject, $buffer, $headers))
    echo '<p class="contact-message-success"> Felicitaciones! su pedido ha sido realizado con ï¿½xito. Un integrante de nuestro staff se comunicarï¿½ con usted a la brevedad. <a href="productos.php">Volver</a></p>';
  else
...
function loadDataTable()
{
  ...
  $buffer.='<td><label style="font-family:helvetica,sans-serif;font-weight:bold;font-size:12px;color:#752C85;" >Razón Social</label><br/>'.$_POST['socialreason'].'</td></tr></table></td></tr>';
  ...
  $buffer.='<td><label style="font-family:helvetica,sans-serif;font-weight:bold;font-size:12px;color:#752C85;" >Teléfono</label><br/>'.$_POST['tel'].'</td>';
  ...
  $buffer.='<td><label style="font-family:helvetica,sans-serif;font-weight:bold;font-size:12px;color:#752C85;" >Categoría I.V.A.</label>'.$_POST['cativa'].'</td></tr></table></td></tr>';
...
//       $buffer.='</body></html>';
	...
	$buffer.="Comentario: ".$_POST['comment']."\n";
      ...
      {
	echo '<p style="font-family:helvetica,sans serif;color:#D4251A" >Su mensaje ha sido enviado con éxito, le responderemos a la brevedad.<a href="contacto.php?contact=show" >Volver</a></p>';
      }
      else
      {
  ...
  else //if($_GET['contact']=='show')
  {
    ...
    $buffer.='<p class="contact-info-title" >CORREO ELECTRÓNICO<br/><span class="contact-info">info@peluchesfantasia.com<br><img style="width:24px;height:24px" src="resources/msn.jpg" >mundo.de.fantasia@hotmail.com<br/><br/></span>TELÉFONOS<br/><span class="contact-info" >(5411) 4953-0646</span><br/>NEXTEL <span class="contact-info" ><br/>693*2293</span></p>';
    $buffer.='</div></div>';
    echo $buffer;
  }
}
