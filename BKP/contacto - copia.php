  ...
  <body onload="javascript:resizemf();">
    ...
    <div class="header-back">
      ...
      <div id="header-front" >
        ...
        <div class="menu-button" >
          <a href="contacto.php" ><span style="visibility:hidden;display:none;" >CONTACTO</span><div id="menu-button-contacto" style="background-image:url(resources/buttonbox/contacto-color.png);"></div></a> 
        </div>
      </div>
    </div>
    <div id="workarea" >
